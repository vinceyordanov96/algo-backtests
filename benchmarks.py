...
class Benchmarks:
    """
    Benchmarks for comparing strategy performance against a market benchmark.
    """
    ...
    def calculate_beta(self, returns: pd.Series, benchmark_returns: pd.Series) -> float:
        """
        Measures strategy sensitivity to benchmark movements.
        """
    ...
    def calculate_alpha(
        ...
        """
        Measures excess return beyond what beta exposure would predict (CAPM alpha).
        """
        aligned_ret, aligned_bench = self._align_returns(returns, benchmark_returns)
        if aligned_ret is None:
            return np.nan
    ...
    def calculate_correlation(self, returns: pd.Series, benchmark_returns: pd.Series) -> float:
        """
    ...
    def calculate_r_squared(self, returns: pd.Series, benchmark_returns: pd.Series) -> float:
        """
        Measures % of strategy variance explained by benchmark.
        """
    ...
    def calculate_treynor_ratio(
        ...
        """
        Measures excess return per unit of systematic (beta) risk.
        """
        aligned_ret, aligned_bench = self._align_returns(returns, benchmark_returns)
        if aligned_ret is None:
            return np.nan
